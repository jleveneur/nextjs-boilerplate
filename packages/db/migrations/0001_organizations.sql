...
--> statement-breakpoint
DROP INDEX "idx_post__user_id";--> statement-breakpoint
ALTER TABLE "post" ADD COLUMN "organization_id" text NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_post__organization_id" ON "post" USING btree ("organization_id");