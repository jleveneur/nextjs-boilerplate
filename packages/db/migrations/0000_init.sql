...
CREATE INDEX "idx_post__user_id" ON "post" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_session__user_id" ON "session" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "idx_verification__identifier" ON "verification" USING btree ("identifier");