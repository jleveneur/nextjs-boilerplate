...
| [0003](./0003-one-domain-core-two-transports.md)            | One domain core behind two API transports                           | Superseded by [0014](./0014-single-transport-and-no-background-worker.md) |
...
| [0009](./0009-bullmq-only-background-work.md)               | BullMQ-only background work                                         | Superseded by [0014](./0014-single-transport-and-no-background-worker.md) |
| [0010](./0010-bullmq-6-pluggable-backends.md)               | BullMQ 6 and ioredis 6                                              | Superseded by [0014](./0014-single-transport-and-no-background-worker.md) |
...
| [0013](./0013-kernel-and-slice-packages.md)                 | A kernel package plus one package per domain slice                  | Accepted                                                                  |
| [0014](./0014-single-transport-and-no-background-worker.md) | One transport, one app, no background worker                        | Accepted                                                                  |
...
| Forward-only migrations, applied by a one-shot image, expand/contract by default | [06 §2](../architecture/06-data-and-storage.md#2-migration-strategy)                                   |
